...
#RUN mkdir -p /go/src/github.com/lifei6671/ && cd /go/src/github.com/lifei6671/ && git clone https://github.com/changming1987117/mindoc.git && cd mindoc

ADD . /go/src/github.com/changming1987117/mindoc

WORKDIR /go/src/github.com/changming1987117/mindoc
...
ADD start.sh /go/src/github.com/changming1987117/mindoc
...
COPY --from=build /go/src/github.com/changming1987117/mindoc /mindoc
